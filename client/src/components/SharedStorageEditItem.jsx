...
function SharedStorageEditItem({ item, onClose, storage_name, onItemUpdate, user_id }) {
  ...
  const handleSave = () => {
    ...
    if (quantity < 1 || expiryDays < 1 || itemName === "" || category === "") {
      alert("Names can't be empty and values must be 1 or greater");
      return;
    }
...
SharedStorageEditItem.propTypes = {
...
export default SharedStorageEditItem;
