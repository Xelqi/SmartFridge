export default function Footer() {
  return (
    // <footer className="footerbg-secondary" style={{position: 'absolute', bottom: '0', width: '100%', height: '2.5rem'}}>
    //   <div className="container text-center text-light">
    //     <p className="display-6">Smart Fridge</p>
    //     <small className="text-white-50">
    //       &copy; Copyright by SmartFridge. All rights reserved
    //     </small>
    //   </div>
    // </footer>
    <footer className="container py-5 d-none d-sm-block">
  <div className="row">
